                ...
                <div className="left-panel">
                    <div className="controls">
                        ...
                        <input
                            ...
                            min="1"
                            placeholder="Стулья на столе"
                        />
                        <button onClick={handleAddTable}>Добавить стол</button>
                        <button onClick={loadSavedTables}>Загрузить данные</button>
                        <button onClick={saveTables}>Сохранить данные</button>
                    </div>
