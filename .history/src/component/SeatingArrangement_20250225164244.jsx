...
const Table = ({ table, setTables, handleDeleteTable, draggingGroup, setDraggingGroup, people }) => {
    // Проводим проверку на undefined перед использованием .map
    const peopleOnTable = Array.isArray(table.people) ? table.people : [];

    // Далее используем peopleOnTable, а не table.people
    const chairs = [];
    const maxChairs = 12;
