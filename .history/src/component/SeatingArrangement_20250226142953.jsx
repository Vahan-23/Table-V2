...
const Table = ({ table, setTables, handleDeleteTable, draggingGroup, setDraggingGroup, people, setPeople }) => {
    ...
    const handleChairClick = (index, event) => {
        ...
        // Set popup position to appear at the click location
        setPopupPosition({
            top: clickY,
            left: clickX
        });
    ...
    // Calculate if popup would go off-screen and adjust if needed
    const adjustPosition = () => {
        ...
        let adjustedLeft = popupPosition.left;
        
        // Adjust horizontally if needed
        if (adjustedLeft + popupWidth > windowWidth) {
            adjustedLeft = adjustedLeft - popupWidth;
        }
        
        // Adjust vertically if needed
        if (adjustedTop + popupHeight > windowHeight) {
            adjustedTop = adjustedTop - popupHeight;
        }
