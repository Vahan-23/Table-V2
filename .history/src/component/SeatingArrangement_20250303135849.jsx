        ...
        return (
            <div className="fullscreen-popup" onClick={() => setShowHallModal(false)}>
                <div className="fullscreen-popup-content" onClick={handleModalClick}>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="hall-form" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="popup-buttons" onClick={e => e.stopPropagation()}>
                            <button 
                                type="submit" 
