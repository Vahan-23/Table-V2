...
const SeatingArrangement = () => {
    ...
    const handleAddPerson = () => {
        if (personName && !people.some(person => person.name === personName)) {
          const newPerson = { name: personName, group: '' };
          setPeople([...people, newPerson]);
          setNotSeated([...notSeated, personName]); // Добавляем человека в список не сидящих
          setPersonName('');
        }
      };
