...
const Table = ({ table, setTables, handleDeleteTable, draggingGroup, setDraggingGroup }) => {
    ...
    for (let i = 0; i < maxChairs; i++) {
        ...
        const xPosition = radius * Math.cos((angle * Math.PI) / 120);
        const yPosition = radius * Math.sin((angle * Math.PI) / 120);
        ...
        const chairStyle = {
            ...
            backgroundImage: table.people[i] ? "url('/red1.png')" : "url('/green1.png')"  , // Правильный путь для public
