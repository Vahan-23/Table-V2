...
useEffect(() => {
    if (isFirstRender.current) {
        ...
        isFirstRender.current = false; // После первого рендера сбрасываем
    }
}, []);
    ...
    const createNewHall = () => {
        ...
        const tableCount = Math.max(1, parseInt(newHallTableCount, 10) || 10);
        const chairCount = Math.max(1, parseInt(newHallChairCount, 10) || 12);
        ...
        setNewHallName('');
        setNewHallTableCount('10'); // Сбрасываем в строку
        setNewHallChairCount('12'); // Сбрасываем в строку
    };
