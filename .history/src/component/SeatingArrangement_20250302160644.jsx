...
const SeatingArrangement = () => {
    ...
    const PeopleSection = ({ people, tables }) => {
        ...
        // Add a delete handler that doesn't close the box
        const handleDeletePersonClick = (event, personName) => {
                                ...
                                {seatedPeople.length > 0 ? (
                                    seatedPeople.map((person, index) => (
                                        <div key={index} className="person-card seated">
                                            ...
                                            <button
                                                onClick={(e) => handleDeletePersonClick(e, person.name)}
        ...
        <DndProvider backend={HTML5Backend}>
            <div className="app-container">
                ...
                <div className="main-content">
                    ...
                    <PeopleSection people={people} tables={tables} />
