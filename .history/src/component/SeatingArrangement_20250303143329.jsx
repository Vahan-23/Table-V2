...
const SeatingArrangement = () => {
    ...
    const createNewHall = () => {
        ...
        const newTables = [];
        const tableCount = Math.max(1, parseInt(newHallTableCount) || 10); // Default to 10 if invalid
        const chairCount = Math.max(1, parseInt(newHallChairCount) || 12); // Default to 12 if invalid
