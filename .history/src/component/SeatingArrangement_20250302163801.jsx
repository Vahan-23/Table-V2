...
const SeatingArrangement = () => {
    ...
    // Add these toggle functions inside the SeatingArrangement component
    ...
    // Calculate seated and unseated people
    const getSeatedAndUnseatedPeople = () => {
        const seatedPeople = [];
        ...
        return { seatedPeople, unseatedPeople, seatedCount: seatedPeople.length };
    };
    
    // Use the function to get the calculated values
    const { seatedPeople, unseatedPeople, seatedCount } = getSeatedAndUnseatedPeople();
    useEffect(() => {
