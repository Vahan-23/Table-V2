...
const SeatingArrangement = () => {
    ...
    const createNewHall = () => {
        ...
        const newTables = [];
        for (let i = 0; i < newHallTableCount; i++) {
            newTables.push({
                id: Date.now() + i,
                people: [],
                chairCount: newHallChairCount
            });
        }
            ...
            <div className="fullscreen-popup" onClick={() => setShowHallModal(false)}>
                <div className="fullscreen-popup-content" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="hall-form">
                        ...
                        <div className="form-group">
                            <label>Աթոռների քանակը մեկ սեղանի համար:</label>
                            <input
                                type="number"
                    ...
                    <div className="popup-buttons">
                        <button onClick={createNewHall} className="primary-btn">
                            Ստեղծել դահլիճ
                        </button>

                        <button onClick={() => setShowHallModal(false)} className="cancel-btn">
                            Չեղարկել
                        </button>
                    </div>
                </div>
