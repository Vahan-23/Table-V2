...
const SeatingArrangement = () => {
    ...
    const HallModal = () => {
        ...
        const tableCountInputRef = useRef(null);
        const chairCountInputRef = useRef(null);
                    ...
                    <form onSubmit={handleSubmit} className="hall-form">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                id="tableCount"
                                type="number"
                                ref={tableCountInputRef}
                                value={newHallTableCount}
                                onChange={(e) => setNewHallTableCount(parseInt(e.target.value) || 1)}
                                min="1"
                                className="input-field"
                            />
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                id="chairCount"
                                type="number"
                                ref={chairCountInputRef}
                                value={newHallChairCount}
                                onChange={(e) => setNewHallChairCount(parseInt(e.target.value) || 1)}
                                min="1"
                                className="input-field"
                            />
                        </div>
